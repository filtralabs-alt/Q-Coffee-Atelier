...
export interface CoverflowCarouselProps {
  ...
  /** Fires on a tap/click that wasn't a drag. Side cards centre themselves
      first; a tap on the already-centred card is reported as activated. */
  onSlideSelect?: (index: number, activated: boolean) => void;
}
...
export function CoverflowCarousel({
  ...
  // A tap and a drag both start as a pointerdown; this stays false until the
  // pointer travels far enough that it can no longer be a tap.
