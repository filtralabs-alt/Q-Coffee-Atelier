...
"journal.drinkAgain": { fr: "Boire à nouveau ?", pt: "Beber de novo?" },
  ...
  "legal.s1.body": { fr: "L'application obaristech.com est éditée par Cris Chal Duarte, entrepreneur individuel. SIRET : 853 148 203 00013. Siège : Clermont-Ferrand (63), France — adresse complète disponible au Registre national des entreprises via le SIRET. E-mail : cris@coffeethinking.com. Téléphone : +33 7 67 04 62 58. Directeur de la publication : Cris Duarte.", pt: "O aplicativo obaristech.com é editado por Cris Chal Duarte, empresário individual (entrepreneur individuel). SIRET: 853 148 203 00013. Sede: Clermont-Ferrand (63), França — endereço completo disponível no Registro Nacional de Empresas via o SIRET. E-mail: cris@coffeethinking.com. Telefone: +33 7 67 04 62 58. Diretor de publicação: Cris Duarte." },
  "legal.s2.title": { fr: "Hébergement", pt: "Hospedagem" },
  "legal.s2.body": { fr: "Les données sont hébergées sur des serveurs sécurisés (Supabase / Railway) situés en Europe.", pt: "Os dados são hospedados em servidores seguros (Supabase / Railway) localizados na Europa." },
