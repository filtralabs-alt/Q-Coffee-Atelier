...
"journal.drinkAgain": { fr: "Boire à nouveau ?", pt: "Beber de novo?" },
  ...
  "legal.title": { fr: "Mentions Légales", pt: "Termos Legais" },
  "legal.updated": { fr: "Dernière mise à jour : septembre 2026", pt: "Última atualização: setembro de 2026" },
  "legal.s1.title": { fr: "Éditeur du site", pt: "Editor do site" },
  "legal.s1.body": { fr: "L'application coffeethinking.com / obaristech.com est éditée par Cris Chal Duarte, entrepreneur individuel. SIRET : 853 148 203 00013. Siège : Clermont-Ferrand (63), France — adresse complète disponible au Registre national des entreprises via le SIRET. E-mail : cris@coffeethinking.com. Téléphone : +33 7 67 04 62 58. Directeur de la publication : Cris Duarte.", pt: "O aplicativo coffeethinking.com / obaristech.com é editado por Cris Chal Duarte, empresário individual (entrepreneur individuel). SIRET: 853 148 203 00013. Sede: Clermont-Ferrand (63), França — endereço completo disponível no Registro Nacional de Empresas via o SIRET. E-mail: cris@coffeethinking.com. Telefone: +33 7 67 04 62 58. Diretor de publicação: Cris Duarte." },
  "legal.s2.title": { fr: "Hébergement", pt: "Hospedagem" },
  "legal.s2.body": { fr: "Le site est hébergé par HostGator (Newfold Digital), 5335 Gate Parkway, Jacksonville, FL 32256, États-Unis. La diffusion et la protection sont assurées via Cloudflare, Inc., 101 Townsend Street, San Francisco, CA 94107, États-Unis.", pt: "O site é hospedado pela HostGator (Newfold Digital), 5335 Gate Parkway, Jacksonville, FL 32256, Estados Unidos. A distribuição e a proteção são garantidas via Cloudflare, Inc., 101 Townsend Street, San Francisco, CA 94107, Estados Unidos." },
  "legal.s3.title": { fr: "Propriété intellectuelle", pt: "Propriedade intelectual" },
  "legal.s3.body": { fr: "L'ensemble des contenus (textes, identités, visuels, vidéos, code) est la propriété de Cris Duarte ou de ses clients, sauf mention contraire. Toute reproduction sans autorisation est interdite. Les marques et symboles de tiers cités à titre d'illustration restent la propriété de leurs détenteurs.", pt: "Todo o conteúdo (textos, identidades, visuais, vídeos, código) é propriedade de Cris Duarte ou de seus clientes, salvo indicação contrária. É proibida qualquer reprodução sem autorização. As marcas e símbolos de terceiros citados a título ilustrativo permanecem propriedade de seus detentores." },
  "legal.s4.title": { fr: "Données personnelles", pt: "Dados pessoais" },
  "legal.s4.body": { fr: "Les traitements liés aux formulaires de l'application sont décrits dans la Politique de confidentialité, disponible ci-dessus.", pt: "Os tratamentos relacionados aos formulários do aplicativo estão descritos na Política de Privacidade, disponível acima." },
  "legal.s5.title": { fr: "Contact", pt: "Contato" },
  "legal.s5.body": { fr: "Pour toute question : cris@coffeethinking.com.", pt: "Para qualquer dúvida: cris@coffeethinking.com." },
